...
o	Key: English category (VD: "Action", "Strategy", "cheap", "Stealth")
o	Value: Vietnamese synonyms + English synonyms (để map ngược về KEY)
o	47 categories được define
o	Mỗi category có 20-50+ từ đồng nghĩa
o	Hỗ trợ gender & age-based: nam/nữ/trẻ em/người lớn/gia đình
o	Logic: User nhập từ trong VALUE → Trả về KEY → Tìm game có KEY trong metadata
