...
const GameDetailPage = () => {
  ...
  const handleConfirmPurchase = async () => {
    ...
    try {
      ...
      enqueueSnackbar(`Mua game ${game.name} thành công! Số dư mới: ${new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(response.data.new_balance)}`, { variant: 'success' });
    } catch (error: any) {
