...
import { ReviewModel, PurchaseModel, GameModel } from '../models'
import { pool } from '../db'
...
export class ReviewController {
   ...
   */
  static async getGameReviews(req: Request, res: Response) {
    try {
  ...
  static async createOrUpdateReview(req: Request, res: Response) {
    try {
      ...
      const result = await ReviewModel.createOrUpdate({ 
        user_id: userId, 
        game_id: gameId, 
        rating, 
        comment 
   ...
   */
  static async getUserRatingForGame(req: Request, res: Response) {
    try {
      const userId = (req as any).user.user_id
   ...
   */
  static async createOrUpdateRating(req: Request, res: Response) {
    try {
      const userId = (req as any).user.user_id
