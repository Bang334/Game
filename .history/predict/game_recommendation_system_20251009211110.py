...
class GameRecommendationSystem:
    ...
    def create_temporal_impact_chart(self, user_id, keyword="", filename=None):
        ...
        # Add 7-day boosted scores
        for rec in recs_7days[:30]:
            game_id = rec['game_id']
            ...
            if game_id in game_scores:
                ...
                base_score = base_rec['hybrid_score'] if base_rec else 0
                
                game_scores[game_id] = {
                    'name': rec['game_name'],
                    'base_score': base_score,
                    '7days_score': rec['hybrid_score'],
                    'base_rank': recs_base.index(base_rec) + 1 if base_rec else None,
