...
export default function AdminHome() {
  ...
  const [publishers, setPublishers] = useState<{publisher_id: number, name: string}[]>([])
  ...
  const addGame = async (e: React.FormEvent) => {
    ...
    if (!title || isNaN(p) || isNaN(pubId)) return
    await api.post('/api/admin/games', { name: title, price: p, publisher_id: pubId })
