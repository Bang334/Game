...
-	Trích xuất keywords từ recent interactions
-	Match với games có similar keywords
...
-	Endpoint chính:
o	GET /recommend/user_id: Gợi ý cho user
o	POST /recommend: Gợi ý với keyword
o	GET /users: Danh sách users
o	GET /user/user_id/profile: User profile và preferences
