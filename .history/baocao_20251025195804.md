...
-	Mỗi category được gắn từ khóa gender/age phù hợp:
-	**NAM**: Action, Shooter, Fighting, Sports, Racing, MOBA (6-8 keys)
-	**NỮ**: Puzzle, Casual, Simulation, Visual Novel (4 keys)
-	**TRẺ EM**: Casual, Educational, Puzzle, Party, Platformer, Board (6 keys)
-	**NGƯỜI LỚN**: Strategy, Horror, RPG, Board (4 keys)
-	**THANH NIÊN/TEEN**: RPG (1 key)
-	**GIA ĐÌNH**: Casual, Educational, Puzzle, Party, Platformer, Board, multiplayer (7 keys)
