            ...
            try:
                ...
                if hasattr(recommender, 'user_item_matrix') and recommender.user_item_matrix is not None:
                    ...
                    if non_zero_count > 0:
                        ...
                        retrain_info['model_parameters']['user_item_matrix']['mean_rating'] = float(non_zero_values.mean())
                        retrain_info['model_parameters']['user_item_matrix']['min_rating'] = float(non_zero_values.min())
                        retrain_info['model_parameters']['user_item_matrix']['max_rating'] = float(non_zero_values.max())
