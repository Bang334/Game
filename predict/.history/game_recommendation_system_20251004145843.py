...
class GameRecommendationSystem:
    ...
    def get_hybrid_recommendations(self, user_id, top_n=10, keyword=""):
        ...
        if user_data:
            ...
            print(f"DEBUG: User {user_id} favorite games: {sorted(favorite_games)}")
            print(f"DEBUG: User {user_id} purchased games: {sorted(purchased_games)}")
            print(f"DEBUG: User {user_id} excluded games: {sorted(excluded_games)}")
            print(f"DEBUG: All games before filtering: {sorted(all_games.keys())}")
            ...
            print(f"DEBUG: Games after filtering: {sorted(filtered_games.keys())}")
        else:
