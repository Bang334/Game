...
class GameRecommendationSystem:
    ...
    def build_content_similarity(self):
        ...
        try:
            ...
            # Tăng similarity lên 5x để có range rộng hơn và giảm số games = 0
            boosted_similarity = similarity_matrix * 5.0
            ...
            print("Content similarity using 2x boosted values (including negative)!")
            print("All features now have equal weights (1x)!")
            print("Boosted similarity provides better distribution!")
            return True
        except Exception as e:
