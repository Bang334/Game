...
class GameRecommendationSystem:
    ...
    def export_recommendations_to_json(self, recommendations, user_data, keyword="", filename=None):
        ...
        if not filename:
            ...
            keyword_suffix = f"_{keyword.replace(' ', '_')}" if keyword else ""
            filename = f"recommendations_{user_name}_{timestamp}{keyword_suffix}.json"
        ...
        export_data = {
            ...
            "weights": WEIGHTS_WITH_KEYWORD if keyword and keyword.strip() else WEIGHTS_NO_KEYWORD,
            "games": []
        }
        
        # Thêm thông tin đầy đủ của từng game
        for i, rec in enumerate(recommendations, 1):
            ...
            game_info = {
                ...
                "price": rec['price'],
                "min_spec": game_full_info.get('min_spec', {}) if game_full_info else {},
                "rec_spec": game_full_info.get('rec_spec', {}) if game_full_info else {},
                ...
                "scores": {
                    ...
                    "svd_score": rec.get('svd_score'),
                    "content_score": rec.get('content_score'),
                    "demographic_score": rec.get('demographic_score'),
