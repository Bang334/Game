...
def create_stacked_bar_chart(recommendations, user_data, top_n=15):
    ...
    # Add hybrid score values on top of each bar
    ...
    print("Chart saved to: game_scores_chart.png")
...
def print_detailed_scores(recommendations, top_n=10):
    """Print detailed scores for verification"""
    print(f"\n=== DETAILED SCORES TOP {top_n} GAMES ===")
...
def main():
    ...
    # Choose user to analyze (can be changed)
    user_id = 2
