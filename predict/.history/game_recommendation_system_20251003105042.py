...
def test_different_configs():
    ...
    print("\n" + "="*60)
    print("TEST CÁC CẤU HÌNH KHÁC NHAU")
    print("="*60)
    
    # Cấu hình 1: Nhấn mạnh favorite
    print("1. Nhấn mạnh Favorite (10, 2, 0):")
    ...
    # Cấu hình 3: Nhấn mạnh purchased
    print("\n3. Nhấn mạnh Purchased (3, 5, 0):")
    update_rating_scores(favorite_rating=3.0, purchased_rating=5.0)
    
    # Cấu hình 4: Trọng số khác
    print("\n4. Trọng số khác (SVD 60%, Content 30%, Demo 10%):")
