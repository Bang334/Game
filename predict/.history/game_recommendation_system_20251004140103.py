...
class GameRecommendationSystem:
    ...
    def build_content_similarity(self):
        ...
        try:
            ...
            # Lưu ma trận similarity gốc (có thể có số âm)
        ...
        try:
            ...
            for game_id in range(1, len(self.games_data) + 1):
                ...
                if similarity_scores:
                    ...
                    # Đảm bảo content score dương bằng cách cộng với giá trị nhỏ nhất
                    min_similarity = self.content_similarity_matrix.min()
                    if min_similarity < 0:
                        avg_similarity = avg_similarity + abs(min_similarity)
                ...
                if user_data and self.content_similarity_matrix is not None:
                    ...
                    if interacted_games:
                        ...
                        if similarities:
                            ...
                            min_similarity = self.content_similarity_matrix.min()
                            if min_similarity < 0:
                                content_score = content_score + abs(min_similarity)
