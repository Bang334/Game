    ...
    if len(interactions) % 10 == 0:
        ...
        try:
            ...
            if recommender:
                ...
                # Ghi log retrain vào file
                log_retrain_info(user_id, interactions)
                
        except Exception as e:
            print(f"❌ Error retraining SVD model: {e}")
            log_retrain_error(user_id, str(e))

def log_retrain_info(user_id, interactions):
    ...
    try:
        ...
        retrain_info = {
            ...
            'interaction_types': {},
            'recent_interactions': [],
            'behavior_patterns': learning_data[user_id].get('behavior_patterns', {}),
            'preferences': learning_data[user_id].get('preferences', {})
        }
