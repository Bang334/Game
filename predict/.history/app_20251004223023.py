            ...
            try:
                ...
                if hasattr(recommender, 'content_similarity_matrix') and recommender.content_similarity_matrix is not None:
                    retrain_info['model_parameters']['content_similarity'] = {
                        ...
                        'mean_similarity': float(recommender.content_similarity_matrix.mean()),
                        'max_similarity': float(recommender.content_similarity_matrix.max()),
                        'min_similarity': float(recommender.content_similarity_matrix.min())
                    }
